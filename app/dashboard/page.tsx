...
import { Pencil, BarChart3, Loader2, LogOut, Copy, Check } from "lucide-react"
...
export default function SoftcardDashboard() {
    ...
    return (
      <div className="softcard-root">
        <style>{`
          ...
          .softcard-copy-btn:hover { background: #ff7bc0; }
  ...
  // 5. VIEW: EDITOR (Hidden logic from previous version)
  return (
    <div className="scdb-dashboard" style={{ fontFamily: `${font}, sans-serif` }}>
      <style>{`
        .scdb-back-btn { 
          background: none; border: 1px solid rgba(255,92,173,0.3); color: #ff5cad; 
          padding: 8px 16px; border-radius: 50px; cursor: pointer; font-weight: 600; font-size: 13px;
      ...
      <div className="scdb-sidebar">
        <button className="scdb-back-btn" onClick={() => setView("hub")}>← Back to Hub</button>
        
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
          <h2 style={{ fontSize: 20 }}>Editor</h2>
      ...
      <div className="scdb-preview">
        ...
        <div className={`scdb-profile-card ${showGlass ? 'glass' : ''}`}>
          <img src={avatar} className="scdb-pfp" style={{ boxShadow: `0 0 30px ${accent}` }} />
