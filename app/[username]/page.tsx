...
export default async function PublicProfile({ params }: { params: { username: string } }) {
  ...
  const supabase = createServerClient(
    ...
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!, // Use the Publishable key from your settings
  ...
  return (
    <div className="relative min-h-screen bg-black flex items-center justify-center overflow-hidden font-sans">
      {/* BACKGROUND: Deep blur and low opacity to make the center pop */}
      <div 
        className="absolute inset-0 bg-cover bg-center opacity-40 scale-110 blur-[60px]"
        style={{ backgroundImage: `url(${profile.bg_url || 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853'})` }}
      />

      {/* THE CONTAINER: This fixes the "big ass" stretching issue */}
      <div className="relative z-10 w-full max-w-[420px] px-6 text-center space-y-6 flex flex-col items-center">
        
        {/* AVATAR: Uniform circle */}
        <div className="w-24 h-24 rounded-full bg-zinc-800 border border-white/10 overflow-hidden shadow-2xl">
          <img 
        ...
        {/* IDENTITY: Clean, tight typography */}
        ...
        {/* SOCIAL ICONS: Uniform pink glow */}
